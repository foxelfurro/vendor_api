...
import { exploreCatalog, getInventory, addToInventory, updateInventoryItem, updateInventoryPhoto, deleteInventoryItem, getSellerCatalogBySlug, updateStoreSettings, addCustomToInventory, getStockAlerts } from './controllers/vendor.controller';
...
app.put('/vendor/inventory/:id/photo', verifyToken, updateInventoryPhoto);
