...
import { exploreCatalog, getInventory, addToInventory, updateInventoryStock, getSellerCatalogBySlug, updateStoreSettings, requestCatalogItem } from './controllers/vendor.controller';
...
app.post('/vendor/request-catalog', verifyToken, requestCatalogItem);
// Ventas y Registro
